...
#define MyAppUrl "https://github.com/SecondLunchi/DawAudioStreamer"
...
begin
  ...
  begin
    ...
    PageMessage :=
      ...
      'Discordで音声を共有するには、Elgato Virtual AudioまたはVB-CABLEなどの' +
      '対応する無音仮想出力が必要です。インストール後もVST画面で状態を確認できます。';
  end
  else
  begin
    ...
    PageMessage :=
      ...
      '・Discordの画面共有音声には、Elgato Virtual AudioまたはVB-CABLEが必要です。' + #13#10 +
