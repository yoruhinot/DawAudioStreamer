...
- [x] 配布者名を`yoruhinot`に確定。
- [x] Copyright holder表記を`Copyright (c) 2026 yoruhinot`に確定。
...
- `DawAudioStreamer-Setup-0.4.0-beta.3.exe`
- `DawAudioStreamer-0.4.0-beta.3-source.zip`
- 両fileのSHA-256
